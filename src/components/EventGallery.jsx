  ...
  return (
    <section className="py-20 px-6">
      <div className="md:w-6xl mx-auto text-center">
        <h2 className="text-5xl md:text-6xl font-medium text-white mb-12 font-hemi-head uppercase">
          Sự Kiện
        </h2>
        <div className="flex flex-col gap-10">
          <div className="flex flex-col md:flex-row justify-between gap-5">
            <img
              src={galary3}
              className="md:w-1/2 h-[300px] object-cover rounded-xl"
              alt=""
            />
            <img
              src={galary2}
          ...
          <div className="flex flex-col md:flex-row gap-5">
            <img
              src={galary4}
              className="md:w-1/3 h-[300px] object-cover rounded-xl"
              alt=""
            />
            <img
              src={galary1}
              className="md:w-2/3 h-[300px] object-cover rounded-xl"
              alt=""
            />
          </div>
        </div>
