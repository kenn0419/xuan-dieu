...
const EventSlider = () => {
  ...
  return (
    <section className="py-20 px-6 relative">
      <div className="swiper-button-prev-custom cursor-pointer w-10 h-10 bg-[#87A0BE] rounded-full flex items-center justify-center shadow absolute top-1/2 left-0 z-[70]">
        <svg
          fill="#000000"
          width="25px"
          height="25px"
